...
if(is_single()) {
	...
	$header_post_url = 'style="background-image:url( ' . $thumb_url_array[0] . ')!important"' ;
}
?>

<div <?php echo $header_post_url ?> class="wpex-site-header-wrap wpex-clr"<?php wpex_schema_markup( 'header' ); ?>>
