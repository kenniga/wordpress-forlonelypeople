...
$args = apply_filters( 'wpex_post_navigation_args', array(
	'prev_text'	=> '<strong>'. esc_html__( 'Previous Article', 'wpex-new-york' ) . '</strong><div class="wpex-link"><span class="fa fa-angle-left"></span>' . '%title</div>',
	'next_text'	=> '<strong>' . esc_html__( 'Next Article', 'wpex-new-york' ) . '</strong><div class="wpex-link">%title' . '<span class="fa fa-angle-right"></span></div>',
) );
