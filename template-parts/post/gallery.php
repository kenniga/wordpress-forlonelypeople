...
if ( $images = wpex_get_gallery_ids() ) :
	...
	$settings = array(
		...
		'loop'        => true,
		'navText'     => array(
			'<span class="fa fa-chevron-left"></span> <span class="wpex-label">' . esc_html__( 'Previous', 'wpex-new-york' ) . '</span>',
			'<span class="wpex-label">' . esc_html__( 'Next', 'wpex-new-york' ) . '</span> <span class="fa fa-chevron-right"></span>',
		),
	); ?>
